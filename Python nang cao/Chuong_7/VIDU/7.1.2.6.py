...
class RadioButtonExample:
    def __init__(self, root):
        ...
        self.radio1 = tk.Radiobutton(self.root, text="Câu trả lời số 1", 
                                     variable=self.selected_option,value=1,
                                     command=self.on_radio_select)
        self.radio2 = tk.Radiobutton(self.root, text="Câu trả lời số 2", 
                                     variable=self.selected_option, value=2,
                                     command=self.on_radio_select)
        self.radio3 = tk.Radiobutton(self.root, text="Câu trả lời số 3", 
    ...
    def on_radio_select(self):
        ...
        print(f"Câu trả lời số {selected_value} đã được lựa chọn.")
